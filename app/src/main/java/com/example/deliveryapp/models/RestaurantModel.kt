...
data class RestaurentModel (val name: String?, val minimum: Int, val delivery_charge: Int, val image: String?, val hours: Hours?, var menus: List<Menus?>?) :
    Parcelable {
...
data class Hours(val Sunday: String?, val Monday: String?, val Tuesday: String?, val Wednesday: String?, val Thursday: String?, val Friday: String?,
    val Saturday: String?) : Parcelable {
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readString(),
        parcel.readString(),
